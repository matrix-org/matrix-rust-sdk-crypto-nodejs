...
-   Update matrix-rust-sdk to `0.18.0`:
    -   Upgrade Ruma to 0.16.0, fixing a deserialization issue for `m.key.verification.accept` events. ([#6628](https://github.com/matrix-org/matrix-rust-sdk/pulls/6628))
